...
# for 20Hz
DEFAULT_PID_GAINS_POSTURE = [1550, 0, 30]  # P, I, D
DEFAULT_PID_GAINS_LINEAR_VELOCITY = [330, 2, 200]  # P, I, D
DEFAULT_PID_GAINS_ANGULAR_VELOCITY = [150, 0, 10]  # P, I, D
# P,I & D for linear position, P for heading
DEFAULT_PID_GAINS_POSITION_CONTROL = [100, 1, 400, 130]
